...
class TP_IphoneXI_Placeables {
   ...
   class controls
   {
       ...
       {
           idc = -1;
           onbuttonclick = "['cursor'] spawn the_programmer_iphone_xi_fnc_apps_placeableRemove;";
       ...
       {
           idc = -1;
           onbuttonclick = "['near'] spawn the_programmer_iphone_xi_fnc_apps_placeableRemove;";
